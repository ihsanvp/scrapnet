...
def read_dataset():
    ...
    label_list = []
    i=0
    my_list = os.listdir(r'C:\Users\91956\PycharmProjects\scrapnet\src\static\dataset')
    for pa in my_list:

        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'C:\Users\91956\PycharmProjects\scrapnet\src\static\dataset\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\91956\PycharmProjects\scrapnet\src\static\dataset\\'+pa, f)
            # print(file_path)
...
# print(predictcnn(r'C:\Users\91956\PycharmProjects\scrapnet\src\static\dataset\50\car-accident-crash-destroyed-3974558 - Copy (3).jpeg'))
